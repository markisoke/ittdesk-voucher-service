...
$unifi_connection = new UniFi_API\Client($controlleruser, $controllerpassword, $controllerurl, $uvs_7d1u_site_id, $controllerversion);
$set_debug_mode   = $unifi_connection->set_debug($debug);
$loginresults     = $unifi_connection->login();

// Then we create the voucher with the requested expiration value and settings
$voucher_result = $unifi_connection->create_voucher($uvs_7d1u_expiration, $uvs_7d1u_count, $uvs_7d1u_quota, $uvs_7d1u_note, $uvs_7d1u_up, $uvs_7d1u_down, $uvs_7d1u_limit);
